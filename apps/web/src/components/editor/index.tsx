...
export const getDefaultExtensions = ({
	...
	CodeBlockLowlight.configure({
		...
		HTMLAttributes: {
			class: cn(
				"my-2 rounded-md border p-4 text-sm",
				"bg-card text-card-foreground",
				"[&_.hljs-doctag]:text-[#C84053] dark:[&_.hljs-doctag]:text-[#957FB8] [&_.hljs-keyword]:text-[#C84053] dark:[&_.hljs-keyword]:text-[#957FB8] [&_.hljs-meta_.hljs-keyword]:text-[#C84053] dark:[&_.hljs-meta_.hljs-keyword]:text-[#957FB8] [&_.hljs-template-tag]:text-[#C84053] dark:[&_.hljs-template-tag]:text-[#957FB8] [&_.hljs-template-variable]:text-[#C84053] dark:[&_.hljs-template-variable]:text-[#957FB8] [&_.hljs-type]:text-[#C84053] dark:[&_.hljs-type]:text-[#957FB8] [&_.hljs-variable.language_]:text-[#C84053] dark:[&_.hljs-variable.language_]:text-[#957FB8]",
				"[&_.hljs-title.class_.inherited__]:text-[#4D699B] dark:[&_.hljs-title.class_.inherited__]:text-[#7AA89F] [&_.hljs-title.class_]:text-[#4D699B] dark:[&_.hljs-title.class_]:text-[#7AA89F] [&_.hljs-title.function_]:text-[#4D699B] dark:[&_.hljs-title.function_]:text-[#7AA89F] [&_.hljs-title]:text-[#4D699B] dark:[&_.hljs-title]:text-[#7AA89F]",
				"[&_.hljs-attr]:text-[#5D57A3] dark:[&_.hljs-attr]:text-[#E6C384] [&_.hljs-attribute]:text-[#5D57A3] dark:[&_.hljs-attribute]:text-[#E6C384] [&_.hljs-literal]:text-[#5D57A3] dark:[&_.hljs-literal]:text-[#E6C384] [&_.hljs-meta]:text-[#D27E99] dark:[&_.hljs-meta]:text-[#D27E99] [&_.hljs-number]:text-[#DA9248] dark:[&_.hljs-number]:text-[#D27E99] [&_.hljs-operator]:text-[#5D57A3] dark:[&_.hljs-operator]:text-[#DCD7BA] [&_.hljs-selector-attr]:text-[#5D57A3] dark:[&_.hljs-selector-attr]:text-[#E6C384] [&_.hljs-selector-class]:text-[#5D57A3] dark:[&_.hljs-selector-class]:text-[#E6C384] [&_.hljs-selector-id]:text-[#5D57A3] dark:[&_.hljs-selector-id]:text-[#E6C384] [&_.hljs-variable]:text-[#5D57A3] dark:[&_.hljs-variable]:text-[#E6C384]",
				"[&_.hljs-meta_.hljs-string]:text-[#6F8F72] dark:[&_.hljs-meta_.hljs-string]:text-[#87A987] [&_.hljs-regexp]:text-[#6F8F72] dark:[&_.hljs-regexp]:text-[#87A987] [&_.hljs-string]:text-[#6F8F72] dark:[&_.hljs-string]:text-[#87A987]",
				"[&_.hljs-built_in]:text-[#DA9248] dark:[&_.hljs-built_in]:text-[#FF5D62] [&_.hljs-symbol]:text-[#DA9248] dark:[&_.hljs-symbol]:text-[#FF5D62]",
				"[&_.hljs-code]:text-[#716E61] dark:[&_.hljs-code]:text-[#727169] [&_.hljs-comment]:text-[#716E61] dark:[&_.hljs-comment]:text-[#727169] [&_.hljs-formula]:text-[#716E61] dark:[&_.hljs-formula]:text-[#727169]",
				"[&_.hljs-name]:text-[#C84053] dark:[&_.hljs-name]:text-[#E46876] [&_.hljs-quote]:text-[#716E61] dark:[&_.hljs-quote]:text-[#727169] [&_.hljs-selector-pseudo]:text-[#5D57A3] dark:[&_.hljs-selector-pseudo]:text-[#E6C384] [&_.hljs-selector-tag]:text-[#C84053] dark:[&_.hljs-selector-tag]:text-[#957FB8]",
				"[&_.hljs-subst]:text-[#434363] dark:[&_.hljs-subst]:text-[#DCD7BA]",
				"[&_.hljs-section]:font-bold [&_.hljs-section]:text-[#4D699B] dark:[&_.hljs-section]:text-[#7AA89F]",
				"[&_.hljs-bullet]:text-[#DA9248] dark:[&_.hljs-bullet]:text-[#E6C384]",
				"[&_.hljs-emphasis]:text-[#434363] [&_.hljs-emphasis]:italic dark:[&_.hljs-emphasis]:text-[#DCD7BA]",
				"[&_.hljs-strong]:font-bold [&_.hljs-strong]:text-[#434363] dark:[&_.hljs-strong]:text-[#DCD7BA]",
				"[&_.hljs-addition]:bg-[#dcecca] [&_.hljs-addition]:text-[#434363] dark:[&_.hljs-addition]:bg-[#434c38] dark:[&_.hljs-addition]:text-[#DCD7BA]",
				"[&_.hljs-deletion]:bg-[#ffdbde] [&_.hljs-deletion]:text-[#434363] dark:[&_.hljs-deletion]:bg-[#43242b] dark:[&_.hljs-deletion]:text-[#DCD7BA]",
			),
		},
	}),
	Superscript,
		...
		<TooltipProvider>
			<div className={cn(className, "[&_.ProseMirror-focused]:outline-none")}>
				<TiptapEditorProvider
					...
					extensions={[
						...getDefaultExtensions({ limit, placeholder }),
						TextStyleKit,
						...(extensions ?? []),
					]}
...
export const EditorTableColumnMenu = ({
	...
	return (
		<DropdownMenu>
			<DropdownMenuTrigger
				className={cn(
					"absolute flex h-4 w-7 -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-md border bg-background shadow-xl",
					{
						hidden: !(left || top),
					},
				)}
		...
		<DropdownMenu>
			<DropdownMenuTrigger
				render={
					<Button
						className={cn(
							"absolute flex h-7 w-4 -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-md border bg-background shadow-xl",
							{
								hidden: !(left || top),
							},
						)}
...
export const EditorBlockMenu = () => {
	...
	return (
		<DragHandle pluginKey="ContentItemMenu" editor={editor}>
