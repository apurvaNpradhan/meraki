...
export const priorities: Priority[] = [
	...
	{ id: "urgent", name: "Urgent", value: 1, icon: UrgentPriorityIcon },
	{ id: "high", name: "High", value: 2, icon: HighPriorityIcon },
	{ id: "medium", name: "Medium", value: 3, icon: MediumPriorityIcon },
	{ id: "low", name: "Low", value: 4, icon: LowPriorityIcon },
];
